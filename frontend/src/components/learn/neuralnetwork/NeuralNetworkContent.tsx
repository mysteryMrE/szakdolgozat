  ...
  return (
    <div className="content-container">
      ...
      <div className="content-box mt-6 flex flex-col gap-4">
        <p>
          A neuron egy alapvető számítási egység, amely több bemenetből egy
          kimenetet képez. A neuronháló neuronok strukturált összekapcsolásával
          jön létre.
        </p>
      </div>
      ...
      <div className="content-box mt-6 ">
        ...
        <p>
          Az ellenfélként használható neuronhálók a 9 mezőt 18 bemeneti
          értékként kapják meg. Ha egy mező üres akkor (0,0), ha X akkor (1,0),
          ha O akkor (0,1). Ezt a bemenetet dolgozzák fel, a kimenetük pedig 9
          érték, ahol a legmagasabb értékű kimenetnek megfelelő sorszámú lépést
          választják.
        </p>
        <p className="mt-4">
          ...
          könnyen értelmezhető valószínűségként a kimenet.
        </p>
      </div>
    </div>
  );
